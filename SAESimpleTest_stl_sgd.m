...
network.minOptions.Method = 'sgd';
network.minOptions.eta = 1;
network.minOptions.minBatchSize = 10000;
network.minOptions.momentum = 0.2;
network.minOptions.streamReader = @SGDStreamRead;
network.minOptions.maxIter = 1000;
network.minOptions.Display = 'iter';
